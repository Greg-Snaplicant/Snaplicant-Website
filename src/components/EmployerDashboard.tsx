...
const EmployerDashboard: React.FC<EmployerDashboardProps> = ({ onBack, onAIMatching }) => {
  ...
  const stats = [
    { label: 'Total Candidates', value: '0', icon: <Users className="w-6 h-6" />, change: 'New platform' },
    { label: 'Profile Views', value: '0', icon: <Eye className="w-6 h-6" />, change: 'Getting started' },
    { label: 'Contact Credits', value: '25', icon: <Mail className="w-6 h-6" />, change: 'Available' },
    { label: 'Bookmarked', value: '0', icon: <Bookmark className="w-6 h-6" />, change: 'Ready to use' }
  ];
  ...
  return (
    <div className="min-h-screen py-6 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {candidates.length > 0 ? (
          ...
          <div className="text-center py-16">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-12 border border-white/10">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">No Candidates Yet</h3>
              <p className="text-white/80 mb-8 max-w-md mx-auto">
                Your candidate database is empty. As job seekers create video profiles on Snaplicant, they'll appear here for you to discover and connect with.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    onClick={onAIMatching}
                    className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
                    Try AI Matching
                  </button>
                  <button className="bg-white/10 hover:bg-white/20 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                    Invite Candidates
                  </button>
                </div>
              </div>
        ...
        {/* Load More - Only show if there are candidates */}
        {candidates.length > 0 && (
