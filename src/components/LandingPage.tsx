...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onCandidateGetStarted }) => {
  ...
  const handleGetStarted = (type: 'candidate' | 'employer' | 'discover' | 'how-it-works' | 'for-employers' | 'pricing' | 'privacy-policy' | 'terms-of-service' | 'help-center') => {
    onGetStarted(type);
  };
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black/20 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-3">
              <button 
                onClick={() => onGetStarted('candidate')}
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/60">
                <li><button onClick={() => onGetStarted('candidate')} className="hover:text-white transition-colors text-left">Features</button></li>
                <li><button onClick={() => onGetStarted('pricing')} className="hover:text-white transition-colors text-left">Pricing</button></li>
                <li><button onClick={() => onGetStarted('how-it-works')} className="hover:text-white transition-colors text-left">How It Works</button></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-4">Company</h4>
              <ul className="space-y-2 text-white/60">
                <li><button onClick={() => onGetStarted('candidate')} className="hover:text-white transition-colors text-left">About</button></li>
                <li><button onClick={() => onGetStarted('candidate')} className="hover:text-white transition-colors text-left">Careers</button></li>
                <li><button onClick={() => onGetStarted('candidate')} className="hover:text-white transition-colors text-left">Contact</button></li>
              </ul>
            </div>
            <div>
